...
public class AddStudent {
	...
	public static String verifyPassword() { 
	    ...
	    {
	    	System.out.println("Oops! You are not meeting the password requirement of 1 uppercase letter, 1 lowercase letter, 1 number, 1 special character, and a minimum of 8 characters. Please enter a new password.");
	    	verifyPassword();
	    }
	...
	public static double getGPA() {
		...
		Scanner kb = new Scanner(System.in); 
		System.out.print("Are you a new student or a transfer student? Enter 'N' for new student and 'T' for transfer student: ");
